...
public final class BinderTest extends TestCase {
  ...
  public void testBasicInjection() {
    G g = Binder.inject(G.class, new Object() {
  ...
  public void testSingletons() {
    J j = Binder.inject(J.class, new Object() {
  ...
  public void testBindingAnnotations() {
    ...
    K k = Binder.inject(K.class, new Object() {
  ...
  public void testSingletonBindingAnnotationAndProvider() {
    ...
    L l = Binder.inject(L.class, new Object() {
  ...
  public void testSingletonInGraph() {
    M m = Binder.inject(M.class, new Object() {
  ...
  public void testSubclasses() {
    Q q = Binder.inject(Q.class, new Object() {
      @Provides F provideF() {
        return new F();
      }
    });
  ...
  public void testSingletonsAreEager() {
    ...
    R.injected = false;
    Binder.inject(A.class, new Object() {
